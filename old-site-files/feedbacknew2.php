...
<div id="wrapperfeedback">
      <div id="top">
       ...
       <div align="right" style="width:133px; direction:top; height:176px; float:right; margin-right:27px;"> <a href="index.html"><img src="image/right-emblem.jpg" border="0"/></a></div>
       ...
       <div style="float:right;  width:24px; height:24px; margin-right:5px; margin-top:155px;"><a href="index arabic.html"><img src="image/ksa.png" border="0" title="Arabic Version"/></a> </div>
       
       
       <div style="float:right; width:24px; height:24px; margin-right:8px; margin-top:155px; "><a href="index.html"><img src="image/uk.png" border="0" title="English Version"/></a> </div>
...
<table width="740" border="1" align="center" cellspacing="0.010" bordercolor="#FCE3AB">
...
<tr><td align="center" colspan="3" width="370">Please take a minute to review our products so we 
can offer a better quality job. Then, fax it to Al-Jazirah 
Aluminium Plant Fax 03.8473927 …
Thanks for helping us to serve you better…	</td><td align="center" colspan="4" width="370">الرجاء أخذ دقائق قصيرة لتقييم المنتج والخدمة وذلك لتحسين <br />
...
<td width="220" lang="ar">قطاعات وتصميم الألمنيوم ؟</td></tr>
...
<td width="220" lang="ar">المرونة والسهولة والأمان ؟
</td>
</tr>
...
<tr><td width="120">Name:</td><td colspan="5" width="430"><input type="text" name="fanme" style="width:380px;"/></td><td>ملاحظات :</td></tr>
<tr><td>Date</td><td colspan="2"><input type="text" name="date" style="width:180px;" /></td><td colspan="4">التاريخ :</td></tr>
