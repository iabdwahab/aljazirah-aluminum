...
export default function AboutUsSectionTypeCard({
  ...
  return (
    <section
      className={`bg-black text-white overflow-hidden px-10 lg:px-18.75 pt-18.75 pb-30 relative rounded-[53px] my-4`}
    >
      <div className="lg:max-w-3/5">
        ...
        <Link
          ...
          className={`bg-[#FFFFFF1A] w-full text-center px-8 md:px-32 leading-15.25 font-bold block md:w-fit rounded-full backdrop-blur-sm `}
        >
