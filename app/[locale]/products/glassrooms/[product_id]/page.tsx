...
export default async function Page({
  ...
  const productsResponse = await fetch(
    `${process.env.NEXT_PUBLIC_WORDPRESS_ACF_API_URL}/products-glassrooms/${product_id}`,
  );
  const productData: {
    acf: {
